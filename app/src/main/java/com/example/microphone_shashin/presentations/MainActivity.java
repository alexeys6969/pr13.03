package com.example.microphone_shashin.presentations;
...
import com.example.microphone_shashin.R;
import com.example.microphone_shashin.datas.permissions.PermissionHelper;
import com.example.microphone_shashin.datas.players.PlayerHelper;
import com.example.microphone_shashin.datas.records.RecordHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    void ChangecolorBth(boolean state) {
        int color = Color.parseColor("#EA4EF4");
